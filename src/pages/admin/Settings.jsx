      ...
      <div className="max-w-4xl space-y-8">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          <div className="px-8 py-6 border-b border-gray-50 flex items-center gap-3">
            <div className="p-2 bg-[#73BF44]/10 rounded-lg">
              <User size={20} className="text-[#73BF44]" />
            </div>
          ...
          <div className="px-8 py-4 bg-gray-50/50 flex justify-end">
            <button className="px-8 py-2.5 bg-[#73BF44] text-white rounded-xl font-bold text-sm hover:bg-[#62a33a] shadow-lg shadow-[#73BF44]/25 transition-all active:scale-95">
              Save Changes
            </button>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          <div className="px-8 py-6 border-b border-gray-50 flex items-center gap-3">
            <div className="p-2 bg-[#73BF44]/10 rounded-lg">
              <Lock size={20} className="text-[#73BF44]" />
            </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          <div className="px-8 py-6 border-b border-gray-50 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-[#73BF44]/10 rounded-lg">
                <Shield size={20} className="text-[#73BF44]" />
              </div>
