    ...
    <div className="animate-in fade-in duration-700 selection:bg-brand-100 selection:text-brand-900">
      ...
      <section className="relative bg-white min-h-[calc(100vh-72px)] flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="flex justify-center items-center gap-2 text-sm font-bold text-brand-500 mb-10 animate-fade-in-up tracking-wider uppercase">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight mb-8 animate-fade-in-up font-heading leading-[1.2]">
            Join the{" "}
          ...
          <p
            className="text-base md:text-lg text-slate-600 max-w-4xl mx-auto mb-14 animate-fade-in-up font-light leading-relaxed text-center"
          ...
          {/* Stats Row */}
          <div
            className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 animate-fade-in-up"
          ...
          >
            {[
              ...
              <div
                key={idx}
                className="bg-white/80 backdrop-blur-sm p-6 md:p-10 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 flex flex-col items-center hover:-translate-y-2 group"
              >
                <div className="mb-3 mt-0 p-3 bg-brand-50 rounded-full text-brand-500 group-hover:scale-110 group-hover:bg-brand-500 group-hover:text-white transition-all duration-300">
                  {stat.icon}
                </div>
                ...
                <div className="text-[11px] text-slate-500 font-black uppercase tracking-widest mt-2 mb-3">
                  {stat.label}
                </div>
              </div>
            ))}
